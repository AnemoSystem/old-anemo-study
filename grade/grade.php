<?php
    ...
    if(isset($_POST['submit'])) {
        $name = $_POST['name'];
        $sql = "INSERT INTO grade (name) VALUES ('$name')";
        $query = mysqli_query($connection, $sql);
    }
    else if(isset($_POST['delete'])) {
        $id_selected = $_POST['delete'];
        $sql = "DELETE FROM grade WHERE id = $id_selected";
...
<html lang="pt">
    <head>
        ...
        <title>Cadastrar Ano Escolar</title>
    </head>
    <body>
        <form method="POST">
                    ...
                    <tr>
                        <?php
							...
							if($row[0] != 0) {
								...
								echo '<tr><td colspan="3">Não existem anos escolares cadastrados ainda!</td></tr>';
							}
