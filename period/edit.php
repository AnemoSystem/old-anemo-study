			...
			<table>
				...
				<tr>
					<th>
            			...
            			<input class="myBtn" type="text" name="name" id="name" value="<?php echo $name; ?>" placeholder="Digite um nome"><br>
						<label for="start_time">Início:</label>
		          		<input class="myBtn" type="time" name="start_time" id="start_time" value="<?php echo $start_time; ?>"><br>
						<label for="end_time">Termíno:</label>
   		        		<input class="myBtn" class="myBtn" type="time" name="end_time" id="end_time" value="<?php echo $end_time; ?>"><br>
